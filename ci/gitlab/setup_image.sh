...
debootstrap --arch=amd64  --include=git,autoconf,automake,gcc,make,pkg-config,e2fslibs-dev,libblkid-dev,zlib1g-dev,liblzo2-dev,asciidoc,xmlto,libzstd-dev,python3.5,python3.5-dev,python3-dev,python3-setuptools,python-setuptools,xz-utils,acl,attr,python3-pip,patch,mount stretch $DIR http://ftp.de.debian.org/debian/
...
cp -v /repo/ci/gitlab/build_btrfsprogs_dduper.sh $DIR/usr/bin/
